...
\begin{itemize}
	...
	\item \reference{6C13}Multiplier un nombre entier par 0,1 ; 0,5 ; 1/2.
...
\begin{itemize}
	...
	\item \reference{6C23}Multiplier un nombre décimal par 0,1 ; 0,5 ; 1/2.
	\item \reference{6C24}Multiplier en utilisant la distributivité simple %multiplier par 14 revient à multiplier par 10, multiplier par 4, puis faire la somme ; 3x + 7x = (3+7)x = 10x
	\item \reference{6C25}Ajouter et soustraire des fractions décimales de même dénominateur.
...
\begin{itemize}
	...
	\item \reference{6C32}Résoudre des problèmes mélangeant les opérations.
	\item \reference{6C33}Organiser un calcul en une seule ligne, utilisant si nécessaire des parenthèses.
	\item \reference{6C34}Utiliser une calculatrice pour introduire la priorité de la multiplication sur l’addition et la soustraction.
	\item \reference{6C35}Ajouter et soustraire des fractions de même dénominateur.
