...
\begin{itemize}
	...
	\item \reference{6N25}Multiplier ou diviser un nombre entier par 10, 100, 1 000… (résultat entier)
\end{itemize}
...
\begin{itemize}
	...
	\item \reference{6N44}Multiplier ou diviser un nombre entier ou décimal par 10, 100, 1 000… (résultat décimal)
	\item \reference{6N45}Utiliser des fractions pour exprimer un quotient. Comprendre que b × a/b = a
\end{itemize}
