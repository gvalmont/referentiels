...
\begin{itemize}
	...
	\item \reference{3G22}Connaître les effets des agrandissements/réductions sur les aires et les volumes.
	\item \reference{3G23}Connaître et utiliser une définition et une propriété caractéristique des triangles semblables.
\end{itemize}
