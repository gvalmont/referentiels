...
\begin{itemize}
	...
	\item \reference{4G25}Encadrer la racine carrée d’un nombre positif entre deux entiers.
	\item \reference{4G26}Utiliser la calculatrice pour déterminer une valeur approchée de la racine carrée d’un nombre positif.
	\item \reference{4G27}Utiliser la racine carrée d’un nombre positif en lien avec des situations géométriques (théorème de Pythagore ; agrandissement, réduction et aires).
\end{itemize}
...
\begin{itemize}
	...
	\item \reference{4G42}Résoudre un problème géométrique en ayant recours au cosinus d'un angle.
\end{itemize}
