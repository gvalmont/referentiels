...
\begin{itemize}
	...
	\item \reference{4C34}Associer à des objets des ordres de grandeur en lien avec d’autres disciplines.
	\item \reference{4C35}Utiliser les ordres de grandeur pour vérifier ses résultats.
\end{itemize}
