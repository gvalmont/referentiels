...
\begin{itemize}
	...
	\item \reference{4C34}Calculs utilisant les priorités opératoires et les puissances.
...
\begin{itemize}
	...
	\item \reference{4L15}Résoudre une équation du type $\frac{x}{a}=\frac{b}{c}$.
	\item \reference{4L16}Identifier la structure d’une expression littérale (somme, produit).
\end{itemize}

\subsection*{Équation}

\begin{itemize}
	\item \reference{4L20}Résoudre algébriquement une équation du premier degré.
\end{itemize}
