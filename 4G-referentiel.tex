...
\begin{itemize}
	...
	\item \reference{4G23}Connaître la définition de la racine carrée d’un nombre positif. %En utilisant les carrés parfaits de 1 à 144 et en utilisant la calculatrice pour déterminer une valeur approchée de la racine carrée d’un nombre positif.
	\item \reference{4G24}Encadrer la racine carrée d’un nombre positif entre deux entiers.%En utilisant les carrés parfaits de 1 à 144 et en utilisant la calculatrice pour déterminer une valeur approchée de la racine carrée d’un nombre positif.
	\item \reference{4G25}Utiliser la racine carrée d’un nombre positif en lien avec des situations géométriques (théorème de Pythagore ; agrandissement, réduction et aires).
\end{itemize}
